...
$sql=mysql_query("insert into roomno(docname,roomno) values('$docname','$roomno')");
if($sql)
{
...
{
echo "<script>alert('Room added Already!');</script>";
				...
				<div class="main-content" >
					<div class="wrap-content container" id="container">
						...
						<div class="container-fluid container-fullw bg-white">
							...
							<select name="docname" class="form-control" required="required">
																<option value="">Select Doctor</option>
<?php $ret=mysql_query("select * from doctors");
