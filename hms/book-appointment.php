...
?>
                                    ...
                                    <input class="form-control datepicker" name="pname"  type="text" required="required" value="<?php $query=mysql_query("select fullName from users where id='".$_SESSION['id']."'");
