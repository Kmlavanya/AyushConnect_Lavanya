...
<html lang="en">
	<head>
		<title>Doctor | Sent Massage</title>
		<meta charset="utf-8" />
				...
				<div class="main-content" >
					<div class="wrap-content container" id="container">
						...
						<section id="page-title">
							<div class="row">
								<div class="col-sm-8">
									<h1 class="mainTitle">Doctor  | Sent Massage</h1>
																	</div>
								<ol class="breadcrumb">
									<li>
										<span>Doctor </span>
									...
									<table class="table table-hover" id="sample-table-1">
										<thead>
											<tr>
												...
												<th class="hidden-xs">To (Patient id)</th>
										...
										<tbody>
<?php
$sql=mysql_query("select * from message  where fromId='".$_SESSION['id']."'");
$cnt=1;
